...
public class CalculatorOperationFactory implements ICalculatorOperationFactory {
	...
	public CalculatorOperationFactory(
			@Qualifier("operation+") ISimpleOperation plusOperation,
			@Qualifier("operation-") ISimpleOperation minusOperation,
			@Qualifier("operation/") ISimpleOperation divisionOperation) {
	...
	@Autowired
	public void setMultiplicationOperation(@Qualifier("operation*")  ISimpleOperation multiplicationOperation) {
